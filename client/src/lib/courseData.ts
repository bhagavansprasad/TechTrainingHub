...
export const courses = [
  ...
  },
  {
    ...
    description: "Python Automation in Network Administration – a hands-on course designed for Network Engineers, by Network Engineers. This course takes you from basic Python to building powerful automation workflows, crafted specifically for real-world network operations",
    price: 32000,
